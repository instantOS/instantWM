...
- fix floating window raising policy
- clearer structure
- formalize new floating window policy
- Merge branch 'dev' of github.com:instantOS/instantWM into dev
- better window placement policy
- better force spawn policy
- fix arrange resetting cursor
- improve performance, fix floating mode switching
- better promote action
- fix promote layout changing bug
- fix computing duplicate candidates performance
- fix zoom 25% screen bug and auto run i3status-rs
- add touch screen support to instantWM wayland
- dedupe
- add touch support to top bar
- fix touch emulation and cursor visibility
...
- speed up arch package build

## [0.1.9](https://github.com/instantOS/instantWM/compare/v0.1.8...v0.1.9) - 2026-06-02

### Other

- fix wrong dependency name

## [0.1.8](https://github.com/instantOS/instantWM/compare/v0.1.7...v0.1.8) - 2026-06-01

### Other

- fix source tarball

## [0.1.7](https://github.com/instantOS/instantWM/compare/v0.1.6...v0.1.7) - 2026-05-31

### Other

- add ipc config manipulation
- Merge branch 'main' of github.com:instantOS/instantWM
- better config ipc side effects
- fix CI again
- better config set side effects

## [0.1.6](https://github.com/instantOS/instantWM/compare/v0.1.5...v0.1.6) - 2026-05-30

### Other

- fix cross compile again?

## [0.1.5](https://github.com/instantOS/instantWM/compare/v0.1.4...v0.1.5) - 2026-05-28

### Other

- fix ARM

## [0.1.4](https://github.com/instantOS/instantWM/compare/v0.1.3...v0.1.4) - 2026-05-27

### Other

- fix CI merge commit ignorance
- refactor CI into scripts
- refactor more
- fix deps

## [0.1.3](https://github.com/instantOS/instantWM/compare/v0.1.1...v0.1.3) - 2026-05-26
...
- add ewmh tag support
- more spec aligned ewmh
- Merge pull request #252 from instantOS/release/version-bump
- ignore aider
- fix CI
