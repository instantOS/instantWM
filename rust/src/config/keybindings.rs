...
pub fn get_keys() -> Vec<Key> {
    let mut keys: Vec<Key> = vec![
        ...
        key!(MODKEY, XK_SPACE           => |ctx| spawn(ctx, &["instantmenu_smartrun"])),
        key!(MC,     XK_SPACE           => |ctx| spawn(ctx, &["instantmenu_run"])),
        key!(MS,     XK_V               => |ctx| spawn(ctx, &["instantclipmenu"])),
        key!(MODKEY, XK_MINUS           => |ctx| spawn(ctx, &["instantmenu_run_st"])),
        key!(MODKEY, XK_V               => |ctx| spawn(ctx, &["quickmenu"])),
        key!(MODKEY, XK_A               => |ctx| spawn(ctx, &["instantassist"])),
        key!(MS,     XK_A               => |ctx| spawn(ctx, &["instantrepeat"])),
        key!(MC,     XK_I               => |ctx| spawn(ctx, &["instantpacman"])),
        key!(MS,     XK_I               => |ctx| spawn(ctx, &["instantshare", "snap"])),
        key!(MODKEY, XK_N               => |ctx| spawn(ctx, &[".config/instantos/default/filemanager"])),
        key!(MODKEY, XK_R               => |ctx| spawn(ctx, &[".config/instantos/default/termfilemanager"])),
        key!(MODKEY, XK_Y               => |ctx| spawn(ctx, &[".config/instantos/default/appmenu"])),
        key!(MODKEY, XK_G               => |ctx| spawn(ctx, &["instantnotify"])),
        key!(MODKEY, XK_X               => |ctx| spawn(ctx, &["iswitch"])),
        key!(MOD1,   XK_TAB             => |ctx| spawn(ctx, &["iswitch"])),
        key!(MODKEY, XK_DEAD_CIRCUMFLEX => |ctx| spawn(ctx, &["rofi", "-show", "window", "-kb-row-down", "Alt+Tab,Down", "-kb-row-up", "Alt+Ctrl+Tab,Up", "-kb-accept-entry", "!Alt_L,!Alt+Tab,Return", "-me-select-entry", "", "-me-accept-entry", "MousePrimary", "-theme", "/usr/share/instantdotfiles/rootconfig/rofi/appmenu.rasi"])),
        key!(MA,     XK_F               => |ctx| spawn(ctx, &["instantsearch"])),
        key!(MA,     XK_SPACE           => |ctx| spawn(ctx, &["instantkeyswitch"])),
        key!(MCA,    XK_L               => |ctx| spawn(ctx, &["ilayout"])),
        key!(MC,     XK_L               => |ctx| spawn(ctx, &[".config/instantos/default/lockscreen"])),
        key!(MSC,    XK_L               => |ctx| spawn(ctx, &["ilock", "-o"])),
        key!(MC,     XK_Q               => |ctx| spawn(ctx, &["instantshutdown"])),
        key!(MS,     XK_ESCAPE          => |ctx| spawn(ctx, &[".config/instantos/default/systemmonitor"])),
        key!(MC,     XK_C               => |ctx| spawn(ctx, &["ins", "settings", "--gui"])),
        key!(MS,     XK_P               => |ctx| spawn(ctx, &["instantdisper"])),
        key!(MODKEY, XK_PRINT => |ctx| spawn(ctx, &["/usr/share/instantassist/assists/s/s.sh"])),
        key!(MS,     XK_PRINT => |ctx| spawn(ctx, &["/usr/share/instantassist/assists/s/m.sh"])),
        key!(MC,     XK_PRINT => |ctx| spawn(ctx, &["/usr/share/instantassist/assists/s/c.sh"])),
        key!(MA,     XK_PRINT => |ctx| spawn(ctx, &["/usr/share/instantassist/assists/s/f.sh"])),
        key!(0, XF86XK_MON_BRIGHTNESS_UP   => |ctx| spawn(ctx, &["/usr/share/instantassist/utils/b.sh", "+"])),
        key!(0, XF86XK_MON_BRIGHTNESS_DOWN => |ctx| spawn(ctx, &["/usr/share/instantassist/utils/b.sh", "-"])),
        key!(0, XF86XK_AUDIO_LOWER_VOLUME  => |ctx| spawn(ctx, &["/usr/share/instantassist/utils/p.sh", "-"])),
        key!(0, XF86XK_AUDIO_MUTE          => |ctx| spawn(ctx, &["/usr/share/instantassist/utils/p.sh", "m"])),
        key!(0, XF86XK_AUDIO_RAISE_VOLUME  => |ctx| spawn(ctx, &["/usr/share/instantassist/utils/p.sh", "+"])),
...
pub fn get_desktop_keybinds() -> Vec<Key> {
    vec![
        ...
        key!(0, XK_R      => |ctx| spawn(ctx, &[".config/instantos/default/termfilemanager"])),
        key!(0, XK_E      => |ctx| spawn(ctx, &[".config/instantos/default/editor"])),
        key!(0, XK_N      => |ctx| spawn(ctx, &[".config/instantos/default/filemanager"])),
        key!(0, XK_SPACE  => |ctx| spawn(ctx, &[".config/instantos/default/appmenu"])),
        key!(0, XK_F      => |ctx| spawn(ctx, &[".config/instantos/default/browser"])),
        key!(0, XK_A      => |ctx| spawn(ctx, &["instantassist"])),
        key!(0, XK_F1     => |ctx| spawn(ctx, &["instanthotkeys", "gui"])),
        key!(0, XK_M      => |ctx| spawn(ctx, &["spoticli", "m"])),
        key!(0, XK_C      => |ctx| spawn(ctx, &["instantutils", "open", "graphicaleditor"])),
        key!(0, XK_Y      => |ctx| spawn(ctx, &["instantmenu_smartrun"])),
        key!(0, XK_V      => |ctx| spawn(ctx, &["quickmenu"])),
        key!(0, XK_TAB    => |ctx| spawn(ctx, &["rofi", "-show", "window", "-kb-row-down", "Alt+Tab,Down", "-kb-row-up", "Alt+Ctrl+Tab,Up", "-kb-accept-entry", "!Alt_L,!Alt+Tab,Return", "-me-select-entry", "", "-me-accept-entry", "MousePrimary", "-theme", "/usr/share/instantdotfiles/rootconfig/rofi/appmenu.rasi"])),
        key!(0, XK_PLUS   => |ctx| spawn(ctx, &["/usr/share/instantassist/utils/p.sh", "+"])),
        key!(0, XK_MINUS  => |ctx| spawn(ctx, &["/usr/share/instantassist/utils/p.sh", "-"])),
