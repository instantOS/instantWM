...
pub struct OverviewState {
    ...
    /// The card receiving the overview's visual emphasis. Pointer hover may
    /// change this without changing keyboard focus; real focus changes keep it
    /// in sync through [`follow_focus`].
...
/// Update overview emphasis from physical pointer motion without stealing
/// keyboard focus. Returns `true` when the overview consumed the hover event.
pub fn hover_window(
    ctx: &mut WmCtx<'_>,
