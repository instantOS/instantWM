...
define_named_actions!(
    ...
    ScrollLeft => { name: "scroll_left", arg_example: None, doc: "scroll tags left", run: |ctx, _args| { animation::anim_scroll(ctx, Direction::Left); } },
    ScrollRight => { name: "scroll_right", arg_example: None, doc: "scroll tags right", run: |ctx, _args| { animation::anim_scroll(ctx, Direction::Right); } },
