...
define_named_actions!(
    ...
    ScrollLeft => { name: "scroll_left", arg_example: None, doc: "scroll tags left", run: |ctx, _args| { crate::tags::view::scroll_view(ctx, Direction::Left); } },
    ScrollRight => { name: "scroll_right", arg_example: None, doc: "scroll tags right", run: |ctx, _args| { crate::tags::view::scroll_view(ctx, Direction::Right); } },
