...
pub fn get_buttons() -> Vec<Button> {
    ...
    vec![
        ...
        btn!(StatusText, 0, button:MouseButton::Left => ButtonAction::spawn(defaults::APPMENU)),
        btn!(StatusText, 0, button:MouseButton::Middle => ButtonAction::spawn(&["kitty"])),
        btn!(StatusText, 0, button:MouseButton::Right => ButtonAction::spawn(ROFI_WINDOW_SWITCH)),
        btn!(StatusText, 0, button:MouseButton::ScrollUp => ButtonAction::spawn(media::UP_VOL)),
        btn!(StatusText, 0, button:MouseButton::ScrollDown => ButtonAction::spawn(media::DOWN_VOL)),
        ...
        btn!(screen:Root, 0, button:MouseButton::Left => ButtonAction::spawn(defaults::APPMENU)),
        btn!(screen:Root, 0, button:MouseButton::Middle => ButtonAction::spawn(menu::RUN)),
        btn!(screen:Root, 0, button:MouseButton::Right => ButtonAction::spawn(menu::SMART)),
        ...
        btn!(ShutDown, 0, button:MouseButton::Left => ButtonAction::spawn(&["instantshutdown"])),
        btn!(ShutDown, 0, button:MouseButton::Middle => ButtonAction::spawn(&["instantlock", "-o"])),
        btn!(ShutDown, 0, button:MouseButton::Right => ButtonAction::spawn(defaults::LOCKSCREEN)),
        btn!(StartMenu, 0, button:MouseButton::Left => ButtonAction::spawn(&["instantstartmenu"])),
        btn!(StartMenu, 0, button:MouseButton::Right => ButtonAction::spawn(&["quickmenu"])),
