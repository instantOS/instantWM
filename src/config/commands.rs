...
pub struct ExternalCommands {
    ...
    pub screenshot_area: &'static [&'static str],
    pub screenshot_full: &'static [&'static str],
    pub screenshot_clipboard: &'static [&'static str],
    pub screenshot_full_clipboard: &'static [&'static str],
...
impl ExternalCommands {
    ...
    pub fn get(&self, cmd: Cmd) -> &'static [&'static str] {
        match cmd {
            ...
            Cmd::ScreenshotArea => self.screenshot_area,
            Cmd::ScreenshotFull => self.screenshot_full,
            Cmd::ScreenshotClipboard => self.screenshot_clipboard,
            Cmd::ScreenshotFullClipboard => self.screenshot_full_clipboard,
...
pub fn default_commands() -> ExternalCommands {
    ExternalCommands {
        ...
        settings: &["ins", "settings", "--gui"],
        code: &["instantutils", "open", "graphicaleditor"],
        startmenu: &["instantstartmenu"],
        screenshot_area: &["ins", "assist", "run", "sp"],
        screenshot_full: &["ins", "assist", "run", "sm"],
        screenshot_clipboard: &["ins", "assist", "run", "sc"],
        screenshot_full_clipboard: &["ins", "assist", "run", "sf"],
