...
pub fn default_commands() -> ExternalCommands {
    ExternalCommands {
        ...
        scrot: &["/usr/share/instantassist/assists/s/s.sh"],
        fscrot: &["/usr/share/instantassist/assists/s/m.sh"],
        clipscrot: &["/usr/share/instantassist/assists/s/c.sh"],
        fclipscrot: &["/usr/share/instantassist/assists/s/f.sh"],
        ...
        spoticli: &["spoticli", "m"],
        upvol: &["/usr/share/instantassist/utils/p.sh", "+"],
        downvol: &["/usr/share/instantassist/utils/p.sh", "-"],
        mutevol: &["/usr/share/instantassist/utils/p.sh", "m"],
        upbright: &["/usr/share/instantassist/utils/b.sh", "+"],
        downbright: &["/usr/share/instantassist/utils/b.sh", "-"],
    }
}
