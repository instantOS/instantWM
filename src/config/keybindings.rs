...
pub fn get_keys() -> Vec<Key> {
    let mut keys: Vec<Key> = vec![
        ...
        key!(MODKEY, XK_M => KeyAction::named(NamedAction::LayoutMonocle)),
        ...
        key!(MODKEY, XK_DOWN => KeyAction::named(NamedAction::DownKey)),
        key!(MODKEY, XK_UP => KeyAction::named(NamedAction::UpKey)),
        key!(MODKEY | CONTROL, XK_J => KeyAction::named(NamedAction::PushDown)),
        key!(MODKEY | CONTROL, XK_K => KeyAction::named(NamedAction::PushUp)),
        key!(MODKEY | CONTROL, XK_LEFT => KeyAction::named(NamedAction::FocusLeft)),
        key!(MODKEY | CONTROL, XK_RIGHT => KeyAction::named(NamedAction::FocusRight)),
        key!(MODKEY | CONTROL, XK_UP => KeyAction::named(NamedAction::FocusUp)),
        key!(MODKEY | CONTROL, XK_DOWN => KeyAction::named(NamedAction::FocusDown)),
        ...
        key!(MODKEY, XK_LEFT => KeyAction::named(NamedAction::ScrollLeft)),
        key!(MODKEY, XK_RIGHT => KeyAction::named(NamedAction::ScrollRight)),
        ...
        key!(MODKEY | SHIFT, XK_LEFT => KeyAction::named(NamedAction::ShiftTagLeft)),
        key!(MODKEY | SHIFT, XK_RIGHT => KeyAction::named(NamedAction::ShiftTagRight)),
        ...
        key!(MODKEY | SHIFT, XK_M => KeyAction::named(NamedAction::BeginKeyboardMove)),
        ...
        key!(MODKEY | CONTROL, XK_UP => KeyAction::named(NamedAction::EdgeScratchpadDirectionUp)),
        key!(MODKEY | CONTROL, XK_DOWN => KeyAction::named(NamedAction::EdgeScratchpadDirectionDown)),
        key!(MODKEY | CONTROL, XK_LEFT => KeyAction::named(NamedAction::EdgeScratchpadDirectionLeft)),
        key!(MODKEY | CONTROL, XK_RIGHT => KeyAction::named(NamedAction::EdgeScratchpadDirectionRight)),
        key!(MODKEY, XK_S => KeyAction::named(NamedAction::ScratchpadToggle)),
        key!(MODKEY, XK_B => KeyAction::named(NamedAction::ToggleBar)),
        key!(MODKEY | CONTROL, XK_F => KeyAction::named(NamedAction::ToggleMaximized)),
        ...
        key!(MODKEY, XK_MINUS => KeyAction::named_args(NamedAction::Spawn, menu::ST)),
